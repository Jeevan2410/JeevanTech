          ...
          <div className="flex flex-col mt-8 justify-center">
            ...
            <Fade bottom delay={300 * 1} triggerOnce>
              <div className="flex flex-col mt-16 mb-12 mx-8 sm:mx-16 xl:mx-28">
                ...
                This project focuses on developing a feature-rich digital platform with a user-friendly interface, seamless functionality, and responsive design to ensure accessibility across devices. It is designed to provide an intuitive experience, efficient data management, and smooth interactions for users.
                </p>
              </div>
