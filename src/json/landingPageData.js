...
export const Portfolios = [
  {
    id: 'asd1293uasdads1',
    title: ' FitTrack – Personalized Fitness & Health App',
    imageUrl: Recruiting,
    type: 'Mobile Apps',
    responsibility: [
      'Mobile Development',
  ...
  {
    id: 'asd1293uhjkhkjh2',
    title: 'TaskGenie – AI-Powered Productivity App',
    imageUrl: Stream,
    type: 'Mobile Apps',
    responsibility: [
      'Mobile Development',
  ...
  {
    id: 'asd1293uvbvcbbd3',
    title: 'TaskMaster – AI-Powered Productivity App ',
    imageUrl: Freelance,
    type: 'Mobile Apps',
    responsibility: [
      'Mobile Development',
  ...
  {
    id: 'asd1293ufgdfgs4',
    title: 'TuneWave – Online Music Streaming & Discovery Platform',
    imageUrl: Aura,
    type: 'Website',
    responsibility: [
      'Web Development',
  ...
  {
    id: 'asd1293ulskmnb5',
    title: 'VogueNest – Fashion & Clothing E-Commerce Store',
    imageUrl: Surtido,
    type: 'Website',
    responsibility: [
      'Web Development',
  ...
  {
    id: 'asd1293ulkmnbj6',
    title: 'CreatiFolio – Personal Portfolio Website for Creatives',
...
export const Testimonials = [
  {
    ...
    testimoni: 'Thanks for JeevanTechnologies, you guys are the best! Keep up the great work!',
    imageUrl: Sasha,
  },
  {
    id: 2,
    ...
    testimoni: 'I just wanted to let you know that it’s been great working with JeevanTechnologies.',
    imageUrl: Kruger,
  },
  {
    id: 3,
    ...
    testimoni: 'JeevanTechnologies is so great. Thank you so much for a job well done.',
    imageUrl: Reiner,
  },
];
